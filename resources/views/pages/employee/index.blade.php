                ...
                <ul class="nav nav-tabs nav-tabs-bottom">
                    <li class="nav-item">
                        <a href="{{ route('employee.index') }}"
                            ...
                            All&nbsp;
                            <span class="badge badge-primary">{{ $employeeCount }}</span>
                        </a>
                    </li>
                    <li class="nav-item">
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    @if (!$employee->trashed())
                                                    <a href="{{ route('employee.edit', $employee->hashid) }}"
                                                        class="dropdown-item">
                                                        <i class="fa fa-pencil m-r-5"></i> Edit
                                                    </a>
                                                    <button type="button" data-hashid="{{ $employee->hashid }}"
...
<script>
    ...
    $('body').on('click', '.btn-swal', function (event) {
        let $this = $(this),
            ...
            url = `{{ route('employee.index') }}/${hashid}`,
