                    ...
                    <table class="table custom-table mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <h2 class="table-avatar">
                                        <a href="client-profile" class="avatar"><img alt=""
                                                src="img/profiles/avatar-07.jpg"></a>
                            ...
                            <tr>
                                <td>
                                    <h2 class="table-avatar">
                                        <a href="client-profile" class="avatar"><img alt=""
                                                src="img/profiles/avatar-06.jpg"></a>
                            ...
                            <tr>
                                <td>
                                    <h2 class="table-avatar">
                                        <a href="client-profile" class="avatar"><img alt=""
                                                src="img/profiles/avatar-14.jpg"></a>
                    ...
                    <table class="table custom-table mb-0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div class="progress progress-xs progress-striped">
                                        <div class="progress-bar" role="progressbar" data-toggle="tooltip" title="65%"
                                            style="width: 65%"></div>
                                    </div>
                                </td>
                                <td class="text-right">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="progress progress-xs progress-striped">
                                        <div class="progress-bar" role="progressbar" data-toggle="tooltip" title="15%"
                                            style="width: 15%"></div>
                                    </div>
                                </td>
                                <td class="text-right">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="progress progress-xs progress-striped">
                                        <div class="progress-bar" role="progressbar" data-toggle="tooltip" title="49%"
                                            style="width: 49%"></div>
                                    </div>
                                </td>
                                <td class="text-right">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="progress progress-xs progress-striped">
                                        <div class="progress-bar" role="progressbar" data-toggle="tooltip" title="88%"
                                            style="width: 88%"></div>
                                    </div>
                                </td>
                                <td class="text-right">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="progress progress-xs progress-striped">
                                        <div class="progress-bar" role="progressbar" data-toggle="tooltip" title="100%"
                                            style="width: 100%">
                                        </div>
                                    </div>
                                </td>
